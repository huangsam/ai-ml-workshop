  ...
  return (
    <div className="flex flex-col h-[340px] rounded-xl border border-white/5 bg-black/40 overflow-hidden shadow-2xl animate-fade-in group">
      ...
      <div className="flex-1 flex overflow-auto bg-[#050505]/40 text-xs custom-scrollbar">
        {/* Line Numbers Column */}
        <div className="sticky left-0 z-20 py-4 select-none text-right pr-3 pl-4 border-r border-white/5 bg-[#0d0d0f] font-mono text-[10px] text-gray-600 w-12 text-balance leading-normal h-fit">
          {codeLines.map((_, i) => (
        ...
        {/* Code Content Column */}
        <pre className="relative z-10 p-4 font-mono text-[11.5px] leading-normal select-text text-gray-300">
          <code
