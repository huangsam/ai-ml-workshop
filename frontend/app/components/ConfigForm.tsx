...
import { Settings2, Zap, Target, AlertTriangle, Play } from "lucide-react";
          ...
          {fields.map(([key, prop]) => {
            ...
            return (
              <div key={key} className="flex flex-col space-y-2">
                ...
                {hasError && (
                  <span className="text-[10px] text-red-400 font-semibold mt-1 flex items-center gap-1.5 animate-fade-in">
